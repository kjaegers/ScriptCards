...
const EncounterHelper = (() => {
    ...
    var translateList = {
        ...
        "specify_name": {
            english: "Please include a name for the encounter on the command line.",
            french: "Veuillez inclure un nom pour la rencontre sur la ligne de commande.",
            spanish: "Incluya un nombre para el encuentro en la línea de comando.",
            german: "Bitte geben Sie in der Befehlszeile einen Namen für die Begegnung ein."
        },        
        "delete_encounter": {
                            ...
                            case "c":
                                if (msg.selected !== undefined) {
                                    if (args !== undefined && args.length > 0) {
                                        ...
                                        sendChat(translate(APINAME), "/w gm " + translate("specify_name"));
                                    }
