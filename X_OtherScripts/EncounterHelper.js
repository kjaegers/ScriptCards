...
Updates		  : 1.0.12b - Added the "include_graphics" config setting and adjusted enocunter creation and update routines to work with Paths as well as tokens. 
                    ...
                    if (theToken !== undefined) {
                        ...
                        mobinfo.forEach(function(info){
                            ...
                            if (theToken.get(infoData[0]) !== undefined) {
                                //log(`Resetting ${infoData[0]} to ${infoData[1]}`);
            ...
            function createEncounter(pageid, encounterName, selected) {
                ...
                selected.forEach(function (entity) {
                    ...
                    if (entity._type === "path") {
                        if (getConfigParameter("include_drawings")) {
